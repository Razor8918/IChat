...
//  IChat
//
//  Created by Георгий Попандопуло on 15.11.2021.
//
...
class ChatRequestViewController: UIViewController {
    ...
    let denyButton = UIButton(title: "Deny", titleColor: .denyColor(), backgroundColor: .black, font: .laoSangamMN20(), isShadow: false, cornerRadius: 10)
